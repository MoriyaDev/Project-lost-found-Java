package com.moriya.project_moriya_java.security.jwt;
...
public class JwtUtils {
    ...
    public String generateTokenFromUsername(String username) {
        ...
        return Jwts.builder()
                ...
                .setExpiration(new Date((new Date()).getTime()+999900000))//מתי יפוג
...
//        return Keys.hmacShaKeyFor(Decoders.BASE64.decode("=============================================sec=============================================================================================================================="));
        return Keys.hmacShaKeyFor(Decoders.BASE64.decode("=======KODESODI============KODESODI==============KODESODI=================KODESODI=====================KODESODI================KODESODI==========KODESODI==========KODESODI=============KODESODI"));
    }
